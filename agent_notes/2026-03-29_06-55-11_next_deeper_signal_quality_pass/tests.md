...
2. `pytest -q src/tests/test_conflict_filter_precision.py src/tests/test_fusion_router_scoring.py src/tests/test_run_pipeline_decision_quality.py src/tests/test_run_pipeline_contract.py`
- Result: pass
- Output: `15 passed`
...
Artifact log: `/opt/cursor/artifacts/run_pipeline_next_deeper_quality_tests.log`
