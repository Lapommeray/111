...
1. `pytest -q src/tests/test_filter_gates.py::test_spread_filter_allows_when_equal_to_threshold src/tests/test_filter_gates.py::test_spread_filter_allows_when_just_below_threshold src/tests/test_filter_gates.py::test_spread_filter_blocks_when_just_above_threshold src/tests/test_run_pipeline_decision_quality.py::test_spread_at_threshold_is_not_blocked_and_reasons_stay_coherent src/tests/test_run_pipeline_decision_quality.py::test_spread_just_below_threshold_is_not_blocked_and_reasons_stay_coherent src/tests/test_run_pipeline_decision_quality.py::test_spread_above_threshold_blocks_with_explicit_reason`
- Result: pass
- Output: `6 passed`

2. `pytest -q src/tests/test_filter_gates.py src/tests/test_run_pipeline_decision_quality.py src/tests/test_run_pipeline_contract.py src/tests/test_conflict_filter_precision.py src/tests/test_fusion_router_scoring.py`
- Result: pass
- Output: `34 passed`
